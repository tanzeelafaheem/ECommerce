...
const PlaceOrder = () => {
  ...
  return (
    <div>
      <div className="flex felx-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-top">
        {/* Left side */}
        <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
         ...
         <input className='border border-gray-300 rounded py-1.5 px-3. w-full' type="tel" placeholder='Phone no.' />
        </div>
        {/* Right side */}
        <div className="mt-8 ">
